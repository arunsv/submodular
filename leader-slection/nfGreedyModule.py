...
def createAnERGraph(nNodes, pE, sd = 0):
    
    G = nx.erdos_renyi_graph(nNodes,pE, seed=sd)
    
    return G

def createABAGraph(nNodes, kavg, sd = 0):
    
    G = nx.barabasi_albert_graph(nNodes,kavg, seed= sd)
